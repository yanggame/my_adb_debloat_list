...
adb shell cmd package install-existing --user 0 com.android.avatarpicker
...
adb shell cmd package install-existing --user 0 com.samsung.accessory.budsunitemgr
...
adb shell cmd package install-existing --user 0 com.samsung.android.mydevice
